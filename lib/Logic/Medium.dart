...
class wComputer extends StatefulWidget {
  const wComputer({super.key});

  @override
  State<wComputer> createState() => _wComputerState();
}

class _wComputerState extends State<wComputer> {
  ...
  bool _checkPotentialWinMove(String symbol) {
    ...
    if ((_board[0][0] == symbol &&
        ...
        (_board[0][2] == symbol &&
            _board[1][1] == symbol &&
            _board[2][0] == '')) {
      int rowIndex = _board[0][0] == symbol ? 2 : 0;
      int colIndex = 1;
      setState(() {
