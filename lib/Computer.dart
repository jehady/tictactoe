...
class wComputerm extends StatefulWidget {
  const wComputerm({super.key});

  @override
  State<wComputerm> createState() => _wComputerState();
}

class _wComputerState extends State<wComputerm> {
  ...
  void _computerMove() {
    if (_winner.isEmpty && _currentPlayer == 'O') {
